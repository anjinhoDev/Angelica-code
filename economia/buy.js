    ...
    .setDescription(`<:dollarmoney:814776832779354132> **Você precisa de  5000₦ animes para comprar a função de *Amador***`)
     .setFooter("・Angelical's Commands", message.author.displayAvatarURL({format: "png"}))
      ...
      if (!args[1]) return message.reply(emb34567)
        ...
        .setColor("#ff58c3")
        .setTitle('SALDO INSUFICIENTE <:736052240669999135:817942453122105344> ❌')
        .setDescription(`<a:tristezaprofunda:794955574693068850> **Você precisa de 3.000¥ ienes para comprar 1(uma) Waifu.**`);
        ...
        .setColor("#ff58c3")
        .setTitle('COMPRA EFETUADA COM SUCESSO <:736052240669999135:817942453122105344> <a:rs_verific_TKG:817950424762023957>')
        .setDescription(`<:r_rosa_oclin_STV:815219643001077771> **Você gastou ${mama}¥ ienes na ${replies[result]} .**`)
        .setThumbnail('https://data.whicdn.com/images/328829944/original.gif')
         .setFooter(`Você comprou ${args[1]} waifu(s)・Angelical's Commands`, message.author.displayAvatarURL({format: "png"}))
      ...
      if (!args[1]) return message.reply(emb23467)
        ...
        .setColor("#ff58c3")
        .setTitle('SALDO INSUFICIENTE <:736052240669999135:817942453122105344> ❌')
        .setDescription(`<a:party7pink:796417061302566954> **Você precisa de 2000¥ ienes para comprar um *Anime.***`)
         .setFooter("・Angelical's Commands", message.author.displayAvatarURL({format: "png"}))
        ...
        .setColor("#ff58c3")
        .setTitle('COMPRA EFETUADA COM SUCESSO <:736052240669999135:817942453122105344> <a:rs_verific_TKG:817950424762023957>')
        .setDescription(`<a:party7pink:796417061302566954> **Você gastou ${papa}¥ ienes em *${replies1[result1]}***`)
      ...
      if (!args[1]) return message.reply(emb234567)
        ...
        .setColor("#ff58c3")
        .setTitle('SALDO INSUFICIENTE <:736052240669999135:817942453122105344> ❌')
        .setDescription(`<a:aganiScary:816355046899187713> **Você precisa de 2₪ mangás para comprar uma *Isca de waifus***`)
         .setFooter("・Angelical's Commands", message.author.displayAvatarURL({format: "png"}))
       ...
       db.add(`isca_${message.guild.id}_${user.id}`, 1)
        ...
        .setColor("#ff58c3")
        .setTitle('COMPRA EFETUADA COM SUCESSO <:736052240669999135:817942453122105344> <a:rs_verific_TKG:817950424762023957>')
        .setDescription(`<a:aganiScary:816355046899187713> **Você comprou uma isca de *waifus***`)
